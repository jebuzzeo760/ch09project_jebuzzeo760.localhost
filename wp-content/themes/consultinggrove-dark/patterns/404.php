...
<main class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--20)"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}},"border":{"radius":"8px"},"typography":{"fontSize":"32px","fontStyle":"normal","fontWeight":"700"},"dimensions":{"minHeight":""}},"backgroundColor":"secondary","fontFamily":"body","layout":{"type":"constrained","contentSize":"900px"}} -->
...
<h2 class="wp-block-heading has-text-align-center has-link-color-color has-text-color has-link-color"><?php echo esc_html__( '404: Page Not Disco-vered', 'consultinggrove-dark' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-link-color-color has-text-color has-link-color" style="font-size:16px;font-style:normal;font-weight:400"><?php echo esc_html__( 'Looks like the dance floor is empty here! This page has done a disappearing act. Head back to the main stage by clicking the navigation links, and let\'s keep the party going!', 'consultinggrove-dark' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-contrast-3-color has-base-background-color has-text-color has-background has-link-color wp-element-button"><?php echo esc_html__( 'Go to home page', 'consultinggrove-dark' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
