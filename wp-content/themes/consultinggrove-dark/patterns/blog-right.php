<?php
 /**
  * Title: Blog Right
  * Slug: consultinggrove-dark/blog-right
  * Inserter: no
  */
?>
...
<h1 class="wp-block-heading has-text-align-center" style="font-size:32px"><?php echo esc_html__( 'Blog Right Sidebar', 'consultinggrove-dark' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
