...
namespace EKLIB\StellarWP\Schema;

use EKLIB\StellarWP\Schema\Config;
use EKLIB\StellarWP\Schema\Fields;
use EKLIB\StellarWP\Schema\Fields\Contracts\Schema_Interface as Field_Schema_Interface;
use EKLIB\StellarWP\Schema\Tables;
use EKLIB\StellarWP\Schema\Tables\Contracts\Schema_Interface as Table_Schema_Interface;
use EKLIB\StellarWP\Schema\Tables\Filters\Group_FilterIterator;
use WP_CLI;
...
class Builder {
	 ...
	 * StellarWP\DB class.
	 *
	 * @var class-string<\EKLIB\StellarWP\DB\DB>
	 */
	protected $db;
	 ...
	 * Constructor.
	 *
	 * @param class-string<\EKLIB\StellarWP\DB\DB>|null $db StellarWP\DB class.
	 ...
	 * @since 1.0.0
	 *
	 * @throws \EKLIB\StellarWP\DB\Database\Exceptions\DatabaseQueryException If the query fails.
	 *
