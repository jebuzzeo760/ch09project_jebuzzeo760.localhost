...
namespace EKLIB\StellarWP\Schema\Tables\Contracts;
...
abstract class Table implements Schema_Interface {
	...
	/**
	 * @var class-string<\EKLIB\StellarWP\DB\DB> The db class.
	 */
	protected $db;
	 ...
	 * @since 1.0.0
	 *
	 * @param class-string<\EKLIB\StellarWP\DB\DB>|null $db StellarWP\DB object.
